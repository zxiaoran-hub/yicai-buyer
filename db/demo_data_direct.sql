...
((SELECT id FROM companies WHERE name='广州美肤化妆品有限公司'), 'cce118c5-78f5-4977-9822-87fe74085b1d',
 '广州美肤化妆品有限公司', '广州美肤', '护肤', '华南', '专业护肤产品代工，10年GMP经验', 2015, 200, 5000, true, true, 1, 4.8, ARRAY['ISO22716','GMPC']::text[], '张经理', 'demo_gz@yicai.demo'),
((SELECT id FROM companies WHERE name='上海丝芙瑞生物科技有限公司'), 'b56016f2-4daa-4dbd-a14c-a76bb94bb644',
 '上海丝芙瑞生物科技有限公司', '上海丝芙瑞', '彩妆', '华东', '高端彩妆研发制造，国际品牌代工', 2012, 350, 8000, true, true, 2, 4.6, ARRAY['ISO22716','FDA']::text[], '李总监', 'demo_sh@yicai.demo'),
((SELECT id FROM companies WHERE name='杭州妍妆科技有限公司'), '0bd203b0-a44b-4cec-a49d-e0a377c81034',
 '杭州妍妆科技有限公司', '杭州妍妆', '面膜', '华东', '面膜/精华专业工厂，支持ODM', 2018, 120, 3000, true, true, 3, 4.5, ARRAY['ISO22716']::text[], '王主管', 'demo_hz@yicai.demo'),
((SELECT id FROM companies WHERE name='广州白云化妆品工厂'), NULL,
 '广州白云化妆品工厂', '白云工厂', '洗护', '华南', '洗护产品OEM，产能充足', 2016, 180, 4500, false, false, NULL, 4.2, ARRAY['GMPC']::text[], '陈厂长', 'contact@baiyun.example'),
...
('f7478991-2b89-45b7-aae8-62f58b8ffe35', (SELECT id FROM suppliers WHERE user_id='cce118c5-78f5-4977-9822-87fe74085b1d'), (SELECT id FROM companies WHERE name='星辰美妆（演示）'), 'cooperating', ARRAY['核心供应商','面膜']::text[], '长期合作，品质稳定', '平台推荐'),
('f7478991-2b89-45b7-aae8-62f58b8ffe35', (SELECT id FROM suppliers WHERE user_id='b56016f2-4daa-4dbd-a14c-a76bb94bb644'), (SELECT id FROM companies WHERE name='星辰美妆（演示）'), 'contacted', ARRAY['彩妆','新供应商']::text[], '已沟通，待打样', '展会接触'),
('f7478991-2b89-45b7-aae8-62f58b8ffe35', (SELECT id FROM suppliers WHERE user_id='0bd203b0-a44b-4cec-a49d-e0a377c81034'), (SELECT id FROM companies WHERE name='星辰美妆（演示）'), 'potential', ARRAY['精华','备选']::text[], '正在了解中', '平台搜索')
ON CONFLICT DO NOTHING;
